// web/menu/src/cities.js — v0.61.256
//
// Parallel copy of web/cuisine/src/v2/lib/cities.js (the two TMAs are separate
...
export function cityRadiusCapM(cityOrName, countryCode) {
  ...
  // v0.61.420 — Johor whole-STATE row (code JOHOR / "Johor state"); 120 km cap.
