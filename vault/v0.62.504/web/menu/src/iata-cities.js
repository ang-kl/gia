...
/**
 * v0.61.249 — parallel copy of web/cuisine/src/v2/lib/iata-cities.js
 * for the Menu Mini-App's mount-time GPS snap. The two TMAs are
 * separate Vite apps with no shared package; same parallel-copy
 * convention used for cities.js / countries.js. Keep the two in sync.
 *
