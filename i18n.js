...
const STRINGS = {
  ...
  // v0.62.901 — §2,911·C, the anonymous context suggestion on the no-results path.
  // Frames + period labels. The BODY of a suggestion is never authored here: it comes from
  // dish.note[lang] (1,682 dishes, complete in all nine) or touristExplainer[lang] (66 of 66).
  'taste.header': { en: "Nothing matched — but while you're here:", fr: "Aucun résultat — mais tant que vous êtes là :", id: "Tidak ada yang cocok — tapi selagi Anda di sini:", ru: "Ничего не найдено — но раз уж вы здесь:", de: "Nichts gefunden — aber wenn Sie schon hier sind:", zh: "没有匹配的结果 —— 不过既然来了：", ja: "該当なし — でもせっかくなので：", es: "Sin resultados — pero ya que estás aquí:", ko: "결과가 없습니다 — 그래도 온 김에:" },
  'taste.noResults': { en: "No {meal} spots found near your set location right now. Try a different location, or type a place name.", fr: "Aucune adresse pour {meal} près de votre position enregistrée. Essayez un autre lieu, ou tapez un nom.", id: "Tidak ada tempat {meal} di dekat lokasi Anda saat ini. Coba lokasi lain, atau ketik nama tempat.", ru: "Рядом с вашей точкой нет мест на {meal}. Попробуйте другое место или введите название.", de: "Keine {meal}-Adressen in der Nähe Ihres Standorts. Versuchen Sie einen anderen Ort oder tippen Sie einen Namen.", zh: "您设定的位置附近暂时找不到{meal}的去处。换个位置，或输入地点名称。", ja: "設定した場所の近くに{meal}のお店が見つかりません。別の場所を試すか、店名を入力してください。", es: "No hay sitios de {meal} cerca de tu ubicación. Prueba otra ubicación o escribe un nombre.", ko: "설정한 위치 근처에 {meal} 장소가 없습니다. 다른 위치를 고르거나 장소 이름을 입력해 보세요." },
  'taste.why.local': { en: "{dish} — a {cuisine} classic", fr: "{dish} — un classique {cuisine}", id: "{dish} — klasik {cuisine}", ru: "{dish} — классика: {cuisine}", de: "{dish} — ein {cuisine} Klassiker", zh: "{dish} —— {cuisine}的经典", ja: "{dish} — {cuisine}の定番", es: "{dish} — un clásico {cuisine}", ko: "{dish} — {cuisine} 대표 음식" },
  'taste.why.neighbour': { en: "{dish} — {cuisine}, close to {seed}", fr: "{dish} — {cuisine}, proche de {seed}", id: "{dish} — {cuisine}, dekat dengan {seed}", ru: "{dish} — {cuisine}, близко к {seed}", de: "{dish} — {cuisine}, nah an {seed}", zh: "{dish} —— {cuisine}，与{seed}相近", ja: "{dish} — {cuisine}、{seed}に近い", es: "{dish} — {cuisine}, cercana a {seed}", ko: "{dish} — {cuisine}, {seed}와 가까운 계열" },
  'taste.why.period': { en: "{dish} — {cuisine}, good for {period}", fr: "{dish} — {cuisine}, parfait pour {period}", id: "{dish} — {cuisine}, cocok untuk {period}", ru: "{dish} — {cuisine}, хорошо на {period}", de: "{dish} — {cuisine}, gut zum {period}", zh: "{dish} —— {cuisine}，适合{period}", ja: "{dish} — {cuisine}、{period}に", es: "{dish} — {cuisine}, ideal para {period}", ko: "{dish} — {cuisine}, {period}에 좋습니다" },
  'taste.why.rain': { en: "{dish} — {cuisine}, worth it in the rain", fr: "{dish} — {cuisine}, idéal sous la pluie", id: "{dish} — {cuisine}, pas saat hujan", ru: "{dish} — {cuisine}, то что нужно в дождь", de: "{dish} — {cuisine}, genau richtig bei Regen", zh: "{dish} —— {cuisine}，雨天正合适", ja: "{dish} — {cuisine}、雨の日にこそ", es: "{dish} — {cuisine}, perfecta con lluvia", ko: "{dish} — {cuisine}, 비 오는 날에 어울립니다" },
  'taste.why.rare': { en: "{dish} — {cuisine}, not something you see often here", fr: "{dish} — {cuisine}, qu'on croise rarement ici", id: "{dish} — {cuisine}, jarang ada di sini", ru: "{dish} — {cuisine}, здесь встречается редко", de: "{dish} — {cuisine}, hier selten zu finden", zh: "{dish} —— {cuisine}，这里不常见", ja: "{dish} — {cuisine}、この街では珍しい", es: "{dish} — {cuisine}, poco común por aquí", ko: "{dish} — {cuisine}, 여기서는 보기 드뭅니다" },
  'taste.period.breakfast': { en: "breakfast", fr: "le petit-déjeuner", id: "sarapan", ru: "завтрак", de: "Frühstück", zh: "早餐", ja: "朝食", es: "el desayuno", ko: "아침" },
  'taste.period.lunch': { en: "lunch", fr: "le déjeuner", id: "makan siang", ru: "обед", de: "Mittagessen", zh: "午餐", ja: "昼食", es: "el almuerzo", ko: "점심" },
  'taste.period.afternoon': { en: "the afternoon", fr: "l'après-midi", id: "sore hari", ru: "полдник", de: "den Nachmittag", zh: "下午", ja: "午後", es: "la tarde", ko: "오후" },
  'taste.period.dinner': { en: "dinner", fr: "le dîner", id: "makan malam", ru: "ужин", de: "Abendessen", zh: "晚餐", ja: "夕食", es: "la cena", ko: "저녁" },
  'taste.period.supper': { en: "late night", fr: "la fin de soirée", id: "makan larut malam", ru: "поздний ужин", de: "den späten Abend", zh: "宵夜", ja: "夜食", es: "la noche", ko: "야식" },
  'taste.period.nightSupper': { en: "the small hours", fr: "le petit matin", id: "dini hari", ru: "глубокую ночь", de: "die frühen Stunden", zh: "深夜", ja: "深夜", es: "la madrugada", ko: "새벽" },
};
