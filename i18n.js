...
const STRINGS = {
  ...
  'privacy.body': {
    en: [
      ...
      '• Search terms — the food / dish / cuisine words you type in free text (or in the Cuisine "Tell me" box) are kept *not linked to you* so Soleat can improve results. No chat identifier is stored with them; expires after 90 days.',
      '',
    ...
    fr: [
      ...
      '• Termes de recherche — les mots de plat / cuisine tapés en texte libre (ou dans la case « Tell me » de Cuisine) sont conservés *sans lien avec vous* pour améliorer les résultats. Aucun identifiant de chat n’est conservé avec eux ; expire après 90 jours.',
      '',
