...
const STRINGS = {
  ...
  // needs them.
  "bot.ratingpref.unratedOnlyBrandNewPlaces": { en: "unrated only (brand-new places)", fr: "sans note (nouveaux lieux uniquement)", id: "tanpa rating saja (tempat baru)", ru: "только без оценок (новые места)", de: "nur ohne Bewertung (ganz neue Orte)", zh: "仅未评分（全新店）", ja: "未評価のみ（新店）", es: "solo sin valoración (sitios nuevos)" },
  "bot.index.yourSharedLocationIsOld": { en: "📍 Your shared location is {age} old. {label} needs a fresher GPS pin (≤ {maxAge} min). Tap the button below to share a new pin, or run \\`/location <place>\\`.", fr: "📍 Votre position partagée date de {age}. {label} a besoin d'un point GPS plus frais (≤ {maxAge} min). Touchez le bouton ci-dessous pour partager une nouvelle position, ou tapez \\`/location <lieu>\\`.", id: "📍 Lokasi yang Anda bagikan sudah {age}. {label} perlu titik GPS yang lebih baru (≤ {maxAge} menit). Ketuk tombol di bawah untuk membagikan titik baru, atau jalankan \\`/location <tempat>\\`.", ru: "📍 Ваша геопозиция отправлена {age} назад. Для {label} нужна более свежая точка GPS (≤ {maxAge} мин). Нажмите кнопку ниже, чтобы отправить новую, или введите \\`/location <место>\\`.", de: "📍 Dein geteilter Standort ist {age} alt. {label} braucht einen frischeren GPS-Punkt (≤ {maxAge} Min). Tippe unten, um einen neuen zu senden, oder nutze \\`/location <Ort>\\`.", zh: "📍 你分享的位置已过去 {age}。{label} 需要更新的 GPS 定位（≤ {maxAge} 分钟）。请点击下方按钮重新分享，或输入 \\`/location <地点>\\`。", ja: "📍 共有された位置情報は{age}前のものです。{label}にはより新しいGPS位置（{maxAge}分以内）が必要です。下のボタンから再送信するか、\\`/location <場所>\\` と入力してください。", es: "📍 Tu ubicación compartida tiene {age}. {label} necesita un punto GPS más reciente (≤ {maxAge} min). Toca el botón de abajo para compartir uno nuevo, o usa \\`/location <lugar>\\`." },
  "bot.index.soleatSPicks": { en: "Soleat's {meal} picks", fr: "Sélections de Soleat · {meal}", id: "Pilihan {meal} dari Soleat", ru: "Подборка Soleat · {meal}", de: "Soleats {meal}-Auswahl", zh: "Soleat 的{meal}精选", ja: "Soleatの{meal}のおすすめ", es: "Selección de Soleat · {meal}" },
  "bot.index.noSavedLocation": { en: "no saved location", fr: "aucun lieu enregistré", id: "tidak ada lokasi tersimpan", ru: "нет сохранённого места", de: "kein gespeicherter Ort", zh: "没有已保存的位置", ja: "保存された位置なし", es: "sin ubicación guardada" },
  "bot.index.menuUnavailableHostNotConfigured": { en: "⚠️ Menu unavailable (host not configured).", fr: "⚠️ Menu indisponible (hôte non configuré).", id: "⚠️ Menu tidak tersedia (host belum dikonfigurasi).", ru: "⚠️ Меню недоступно (хост не настроен).", de: "⚠️ Menü nicht verfügbar (Host nicht konfiguriert).", zh: "⚠️ 菜单不可用（主机未配置）。", ja: "⚠️ メニューを利用できません（ホスト未設定）。", es: "⚠️ Menú no disponible (host no configurado)." },
  "bot.index.soleatMenuTapToOpen": { en: "🍚 *Soleat Menu* — tap to open.", fr: "🍚 *Soleat Menu* — touchez pour ouvrir.", id: "🍚 *Soleat Menu* — ketuk untuk membuka.", ru: "🍚 *Soleat Menu* — нажмите, чтобы открыть.", de: "🍚 *Soleat Menu* — zum Öffnen tippen.", zh: "🍚 *Soleat Menu* — 点击打开。", ja: "🍚 *Soleat Menu* — タップして開く。", es: "🍚 *Soleat Menu* — toca para abrir." },
  "bot.index.openMenu": { en: "Open menu", fr: "Ouvrir le menu", id: "Buka menu", ru: "Открыть меню", de: "Menü öffnen", zh: "打开菜单", ja: "メニューを開く", es: "Abrir menú" },
  ...
  "bot.index.searchingAround200M3": { en: "🔍 Searching around *{place}* (200 m – 3 km)…", fr: "🔍 Recherche autour de *{place}* (200 m – 3 km)…", id: "🔍 Mencari di sekitar *{place}* (200 m – 3 km)…", ru: "🔍 Ищу рядом с *{place}* (200 м – 3 км)…", de: "🔍 Suche rund um *{place}* (200 m – 3 km)…", zh: "🔍 正在 *{place}* 周边搜索（200 米 – 3 公里）…", ja: "🔍 *{place}* の周辺を検索中（200 m〜3 km）…", es: "🔍 Buscando cerca de *{place}* (200 m – 3 km)…" },
  "bot.index.viewAllPicksOnOne": { en: "🗺 View all {count} picks on one map:", fr: "🗺 Voir les {count} trouvailles sur une carte :", id: "🗺 Lihat semua {count} pilihan di satu peta:", ru: "🗺 Показать все {count} мест на одной карте:", de: "🗺 Alle {count} Treffer auf einer Karte:", zh: "🗺 在一张地图上查看全部 {count} 个推荐：", ja: "🗺 {count}件すべてを1つの地図で見る：", es: "🗺 Ver los {count} sitios en un mapa:" },
  "bot.index.openOnMap": { en: "🗺 Open {count} on map", fr: "🗺 Voir les {count} sur la carte", id: "🗺 Buka {count} di peta", ru: "🗺 Открыть {count} на карте", de: "🗺 {count} auf der Karte", zh: "🗺 在地图查看 {count} 个", ja: "🗺 地図で{count}件を見る", es: "🗺 Ver {count} en el mapa" },
  ...
  "bot.index.iVenueVerifiedWithinRadius": { en: "✓ <i>{a} venue{b} verified within radius · ranking by distance…</i>", fr: "✓ <i>{a} candidat{b} dans le rayon · classement par distance…</i>", id: "✓ <i>{a} tempat terverifikasi dalam radius · mengurutkan berdasarkan jarak…</i>", ru: "✓ <i>{a} мест подтверждено в радиусе · сортировка по расстоянию…</i>", de: "✓ <i>{a} Lokale im Radius bestätigt · Sortierung nach Entfernung…</i>", zh: "✓ <i>半径内已验证 {a} 家 · 正在按距离排序…</i>", ja: "✓ <i>範囲内で{a}件を確認 · 距離順に並べ替え中…</i>", es: "✓ <i>{a} locales verificado dentro del radio · ordenando por distancia…</i>" },
  "bot.index.iWideningTo15": { en: "↻ <i>Widening to 1.5–3 km…</i>", fr: "↻ <i>Élargissement à 1.5–3 km…</i>", id: "↻ <i>Memperluas ke 1,5–3 km…</i>", ru: "↻ <i>Расширяю до 1,5–3 км…</i>", de: "↻ <i>Erweitere auf 1,5–3 km…</i>", zh: "↻ <i>扩大到 1.5–3 公里…</i>", ja: "↻ <i>1.5〜3 kmに範囲を拡大中…</i>", es: "↻ <i>Ampliando a 1,5–3 km…</i>" },
  "bot.index.iWiderClaudeWebSearch": { en: "↻ <i>Wider Claude web search (up to 90 s)…</i>", fr: "↻ <i>Recherche élargie via Claude (jusqu\\'à 90 s)…</i>", id: "↻ <i>Pencarian web Claude yang lebih luas (hingga 90 dtk)…</i>", ru: "↻ <i>Расширенный веб-поиск Claude (до 90 с)…</i>", de: "↻ <i>Erweiterte Claude-Websuche (bis zu 90 s)…</i>", zh: "↻ <i>更大范围的 Claude 网络搜索（最长 90 秒）…</i>", ja: "↻ <i>Claudeによる広域ウェブ検索（最大90秒）…</i>", es: "↻ <i>Búsqueda web ampliada con Claude (hasta 90 s)…</i>" },
  "bot.index.noClipAtThatIndex": { en: "❓ No clip at that index.", fr: "❓ Aucun clip à cet emplacement.", id: "❓ Tidak ada klip pada indeks itu.", ru: "❓ По этому номеру клипа нет.", de: "❓ Kein Clip an dieser Position.", zh: "❓ 该编号没有剪辑。", ja: "❓ その番号のクリップはありません。", es: "❓ No hay ningún clip en ese índice." },
  "bot.index.openSketchbook": { en: "📋 Open Sketchbook", fr: "📋 Ouvrir Sketchbook", id: "📋 Buka Sketchbook", ru: "📋 Открыть Sketchbook", de: "📋 Sketchbook öffnen", zh: "📋 打开 Sketchbook", ja: "📋 Sketchbookを開く", es: "📋 Abrir Sketchbook" },
  "bot.index.noClipsMatching": { en: "📋 No clips matching \"{cuisine}\".", fr: "📋 Aucun clip pour « {cuisine} ».", id: "📋 Tidak ada klip untuk \\\"{cuisine}\\\".", ru: "📋 Нет клипов по запросу «{cuisine}».", de: "📋 Keine Clips für „{cuisine}“.", zh: "📋 没有匹配 \\\"{cuisine}\\\" 的剪辑。", ja: "📋 「{cuisine}」に一致するクリップはありません。", es: "📋 No hay clips para «{cuisine}»." },
  "bot.index.noClipsYetTapCopy": { en: "📋 No clips yet. Tap Copy in the cuisine picker, or open Sketchbook.", fr: "📋 Vous n\\'avez pas encore de clips. Touchez « Copier » dans le sélecteur, ou ouvrez Sketchbook.", id: "📋 Belum ada klip. Ketuk Salin di pemilih masakan, atau buka Sketchbook.", ru: "📋 Клипов пока нет. Нажмите «Копировать» в выборе кухни или откройте Sketchbook.", de: "📋 Noch keine Clips. Tippe im Küchen-Picker auf Kopieren oder öffne Sketchbook.", zh: "📋 还没有剪辑。在菜系选择器中点「复制」，或打开 Sketchbook。", ja: "📋 まだクリップがありません。料理ピッカーの「コピー」をタップするか、Sketchbookを開いてください。", es: "📋 Aún no hay clips. Toca Copiar en el selector de cocina, o abre Sketchbook." },
  "bot.index.yourLastClips": { en: "📋 Your last clips · \"{cuisine}\"", fr: "📋 Vos derniers clips · « {cuisine} »", id: "📋 Klip terakhir Anda · \\\"{cuisine}\\\"", ru: "📋 Ваши последние клипы · «{cuisine}»", de: "📋 Deine letzten Clips · „{cuisine}“", zh: "📋 你最近的剪辑 · \\\"{cuisine}\\\"", ja: "📋 最近のクリップ · 「{cuisine}」", es: "📋 Tus últimos clips · «{cuisine}»" },
  "bot.index.yourLastClips2": { en: "📋 Your last clips", fr: "📋 Vos derniers clips", id: "📋 Klip terakhir Anda", ru: "📋 Ваши последние клипы", de: "📋 Deine letzten Clips", zh: "📋 你最近的剪辑", ja: "📋 最近のクリップ", es: "📋 Tus últimos clips" },
  "bot.index.noCuisine": { en: "— no cuisine —", fr: "— pas de cuisine —", id: "— tanpa masakan —", ru: "— без кухни —", de: "— keine Küche —", zh: "— 无菜系 —", ja: "— ジャンルなし —", es: "— sin cocina —" },
  "bot.index.venue": { en: "venue", fr: "lieu", id: "tempat", ru: "место", de: "Lokal", zh: "家", ja: "件", es: "local" },
  "bot.index.venues": { en: "venues", fr: "lieux", id: "tempat", ru: "мест", de: "Lokale", zh: "家", ja: "件", es: "locales" },
  "bot.index.totalShowingFirst": { en: "{total} total · showing first {count}.", fr: "Voir plus : {total} clips au total.", id: "{total} total · menampilkan {count} pertama.", ru: "Всего {total} · показаны первые {count}.", de: "{total} insgesamt · zeige die ersten {count}.", zh: "共 {total} 条 · 显示前 {count} 条。", ja: "全{total}件 · 最初の{count}件を表示。", es: "{total} en total · mostrando los primeros {count}." },
  "bot.index.minAgo": { en: "{n} min ago", fr: "il y a {n} min", id: "{n} mnt lalu", ru: "{n} мин назад", de: "vor {n} Min", zh: "{n} 分钟前", ja: "{n}分前", es: "hace {n} min" },
  "bot.index.hAgo": { en: "{n} h ago", fr: "il y a {n} h", id: "{n} jam lalu", ru: "{n} ч назад", de: "vor {n} Std", zh: "{n} 小时前", ja: "{n}時間前", es: "hace {n} h" },
  "bot.index.dAgo": { en: "{n} d ago", fr: "il y a {n} j", id: "{n} hr lalu", ru: "{n} дн назад", de: "vor {n} T", zh: "{n} 天前", ja: "{n}日前", es: "hace {n} d" },
  "bot.index.wAgo": { en: "{n} w ago", fr: "il y a {n} sem", id: "{n} mgg lalu", ru: "{n} нед назад", de: "vor {n} Wo", zh: "{n} 周前", ja: "{n}週間前", es: "hace {n} sem" },
  ...
  "bot.index.authenticDishes": { en: "🍛 Authentic Dishes", fr: "🍛 Plats authentiques", id: "🍛 Hidangan Autentik", ru: "🍛 Аутентичные блюда", de: "🍛 Authentische Gerichte", zh: "🍛 地道菜肴", ja: "🍛 本場の料理", es: "🍛 Platos auténticos" },
  "bot.index.othersFreeText": { en: "💡 Others (free text)", fr: "💡 Autres (texte libre)", id: "💡 Lainnya (teks bebas)", ru: "💡 Другое (свободный текст)", de: "💡 Sonstiges (Freitext)", zh: "💡 其他（自由输入）", ja: "💡 その他（自由入力）", es: "💡 Otros (texto libre)" },
  "bot.index.back": { en: "↩ Back", fr: "↩ Retour", id: "↩ Kembali", ru: "↩ Назад", de: "↩ Zurück", zh: "↩ 返回", ja: "↩ 戻る", es: "↩ Atrás" },
  ...
  "bot.index.byDishType": { en: "by dish type", fr: "par type de plat", id: "menurut jenis hidangan", ru: "по типу блюда", de: "nach Gerichtsart", zh: "按菜品类型", ja: "料理の種類順", es: "por tipo de plato" },
  "bot.index.byNationality": { en: "by nationality", fr: "par nationalité", id: "menurut kebangsaan", ru: "по национальности", de: "nach Nationalität", zh: "按国别", ja: "国・地域順", es: "por nacionalidad" },
  ...
  "bot.index.couldnTRenameTheClip": { en: "❌ Couldn't rename — the clip may no longer exist.", fr: "❌ Renommage impossible — le clip n'existe peut-être plus.", id: "❌ Gagal mengubah nama — klip mungkin sudah tidak ada.", ru: "❌ Не удалось переименовать — клипа, возможно, больше нет.", de: "❌ Umbenennen fehlgeschlagen — der Clip existiert möglicherweise nicht mehr.", zh: "❌ 重命名失败 — 该剪辑可能已不存在。", ja: "❌ 名前を変更できませんでした — クリップが存在しない可能性があります。", es: "❌ No se pudo renombrar — puede que el clip ya no exista." },
  "bot.index.resultsFor": { en: "🔎 Results for \"{dish}\"", fr: "🔎 Résultats pour \"{dish}\"", id: "🔎 Hasil untuk \\\"{dish}\\\"", ru: "🔎 Результаты по «{dish}»", de: "🔎 Ergebnisse für „{dish}“", zh: "🔎 \\\"{dish}\\\" 的搜索结果", ja: "🔎 「{dish}」の検索結果", es: "🔎 Resultados de «{dish}»" },
  ...
  "bot.langname.en": { en: "English", fr: "anglais", id: "bahasa Inggris", ru: "английском", de: "Englisch", zh: "英语", ja: "英語", es: "inglés" },
  "bot.langname.fr": { en: "French", fr: "français", id: "bahasa Prancis", ru: "французском", de: "Französisch", zh: "法语", ja: "フランス語", es: "francés" },
  "bot.langname.id": { en: "Indonesian", fr: "indonésien", id: "bahasa Indonesia", ru: "индонезийском", de: "Indonesisch", zh: "印尼语", ja: "インドネシア語", es: "indonesio" },
  "bot.langname.ru": { en: "Russian", fr: "russe", id: "bahasa Rusia", ru: "русском", de: "Russisch", zh: "俄语", ja: "ロシア語", es: "ruso" },
  "bot.langname.de": { en: "German", fr: "allemand", id: "bahasa Jerman", ru: "немецком", de: "Deutsch", zh: "德语", ja: "ドイツ語", es: "alemán" },
  "bot.langname.zh": { en: "Chinese", fr: "chinois", id: "bahasa Tionghoa", ru: "китайском", de: "Chinesisch", zh: "中文", ja: "中国語", es: "chino" },
  "bot.langname.ja": { en: "Japanese", fr: "japonais", id: "bahasa Jepang", ru: "японском", de: "Japanisch", zh: "日语", ja: "日本語", es: "japonés" },
  "bot.langname.es": { en: "Spanish", fr: "espagnol", id: "bahasa Spanyol", ru: "испанском", de: "Spanisch", zh: "西班牙语", ja: "スペイン語", es: "español" },
  ...
  "bot.index.yesSwitch": { en: "✅ Yes, switch", fr: "✅ Oui, changer", id: "✅ Ya, ganti", ru: "✅ Да, переключить", de: "✅ Ja, wechseln", zh: "✅ 是，切换", ja: "✅ はい、切り替える", es: "✅ Sí, cambiar" },
  "bot.index.noKeep": { en: "🚫 No, keep", fr: "🚫 Non, garder", id: "🚫 Tidak, biarkan", ru: "🚫 Нет, оставить", de: "🚫 Nein, behalten", zh: "🚫 否，保持", ja: "🚫 いいえ、そのまま", es: "🚫 No, mantener" },
  "bot.index.queueEstimate": { en: "Queue estimate", fr: "Estimation file d’attente", id: "Perkiraan antrean", ru: "Оценка очереди", de: "Wartezeit-Schätzung", zh: "排队预估", ja: "待ち時間の目安", es: "Estimación de cola" },
  "bot.index.queueDeparting": { en: "depart", fr: "sortie", id: "keluar", ru: "выезд", de: "Ausreise", zh: "出境", ja: "出国", es: "salida" },
  "bot.index.queueArriving": { en: "arrive", fr: "entrée", id: "masuk", ru: "въезд", de: "Einreise", zh: "入境", ja: "入国", es: "entrada" },
  "bot.index.queueOverall": { en: "overall", fr: "global", id: "keseluruhan", ru: "в целом", de: "gesamt", zh: "总体", ja: "全体", es: "total" },
  "bot.index.queueSource": { en: "source: ICA · unofficial scrape", fr: "source : ICA · scraping non officiel", id: "sumber: ICA · pengambilan tidak resmi", ru: "источник: ICA · неофициальный сбор данных", de: "Quelle: ICA · inoffizieller Scrape", zh: "来源：ICA · 非官方抓取", ja: "出典：ICA · 非公式スクレイピング", es: "fuente: ICA · scraping no oficial" },
  ...
  "bot.index.locationUpdatedTo": { en: "✅ Location updated to <b>{place}</b>.", fr: "✅ Lieu mis à jour vers <b>{place}</b>.", id: "✅ Lokasi diperbarui menjadi <b>{place}</b>.", ru: "✅ Место обновлено на <b>{place}</b>.", de: "✅ Ort aktualisiert auf <b>{place}</b>.", zh: "✅ 位置已更新为 <b>{place}</b>。", ja: "✅ 位置を <b>{place}</b> に更新しました。", es: "✅ Ubicación actualizada a <b>{place}</b>." },
  ...
  "bot.ratingpref.anyRating": { en: "any rating (no minimum)", fr: "toutes les notes (aucun minimum)", id: "semua rating (tanpa minimum)", ru: "любая оценка (без минимума)", de: "jede Bewertung (kein Minimum)", zh: "任意评分（无下限）", ja: "評価を問わない（下限なし）", es: "cualquier valoración (sin mínimo)" },
  "bot.index.justNow": { en: "just now", fr: "à l'instant", id: "baru saja", ru: "только что", de: "gerade eben", zh: "刚刚", ja: "たった今", es: "justo ahora" },
