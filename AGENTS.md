# AGENTS.md — repo root orchestration

This is the **Soleat** (`gia` / "Gia4lunch") Telegram bot + Mini Apps + Express server.

## Documentation protocol

The full doc contract lives in **`doc/AGENTS.md`** (lean orchestrator) and `doc/Codex-FULL.md`
...
Run the `gia-preflight` checklist (`.Codex/skills/gia-preflight/SKILL.md`, `/gia-preflight`)
