...
const ENTRIES = [
  ...
  { id: 'mo-mfm-utm-educational-restaurant', city: 'Macau', country: 'MO', name: 'UTM Educational Restaurant', address: 'Colina de Mong-Há, Macau', cuisine: 'macanese', vegetarian: true, halal: false, awards: [ { year: 2026, category: 'bib-gourmand' } ], greenStarYears: [2026] }
]
