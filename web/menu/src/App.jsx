...
const SECTIONS = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { id: 'hawker', icon: '🥢', iconImage: '/app/menu/hawker-icon-v2.png', iconImgClass: 'max-h-9 max-w-full object-contain scale-[1.3]', labelKey: 'tile.hawker.label', subKey: 'tile.hawker.sub', kind: 'navigate', path: '/app/hawker' }
    ]
  },
