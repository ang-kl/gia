...
export default function HawkerMapPanel({ centres, region, overlayLayers, onOverlayChange = null }) {
  ...
  return (
    <div className="rounded-lg border border-tg-border bg-tg-card overflow-hidden relative">
      ...
      {zoomLevel != null && (
        <div
          className="absolute bottom-3 right-3 w-8 h-8 rounded-full bg-white shadow-md border border-gray-300 flex items-center justify-center text-xs font-bold text-gray-900 z-10 pointer-events-none select-none"
          aria-hidden
        >
