...
// BackButton (wired in tg.js) is hidden in fullscreen on iPad, and
// even when visible some users don't notice it. The FAB is an
// always-on-screen affordance that mirrors the same handler:
// pop history if there is one, otherwise close the WebApp.
