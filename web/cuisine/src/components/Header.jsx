...
export default function Header({ loc, onLoc, debugOn, onToggleDebug }) {
  ...
  // v0.30.2: show the resolved coords directly under the title so the
  // user always knows what location Gia is using. Re-detect button
  ...
  return (
    <div className="px-3 py-2 border-b border-tg-border">
      ...
      <p className="text-[11px] text-tg-hint font-mono mt-1 truncate">{locLabel}</p>
    </div>
  );
}
