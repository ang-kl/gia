// web/cuisine/src/v2/lib/cities.js — v0.61.228
//
// Parallel copy of web/menu/src/cities.js. The two TMAs are separate
// Vite apps with no shared package, so this file is intentionally
// duplicated. Keep the two lists in sync (same convention as the
// existing countries.js duplication).
//
// Per-country city catalogue for the cascading "common destination"
// dropdown next to the country flag in the Cuisine TMA's location
// field (and v0.61.227's Menu TMA equivalent).
//
