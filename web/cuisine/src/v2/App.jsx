...
export default function App() {
  ...
  // v0.62.261 — operator (urgent): trace the folio-tab loading state so a MISSING
  // "Pick local classic ▾" tab is diagnosable. MUST sit AFTER classicOpen is
  // declared — placing it earlier put classicOpen in the temporal dead zone and
  // crashed the whole TMA to a blank screen (the v0.62.259 regression).
  useEffect(() => {
