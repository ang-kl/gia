...
const STRINGS = {
  ...
  'chrome.cuisineFilters':  { en: '🍜 Cuisine & Filter', fr: '🍜 Cuisine & filtre', id: '🍜 Masakan & filter', ru: '🍜 Кухня и фильтр', de: '🍜 Küche & Filter' },
  'chrome.pickLocal':       { en: '📍 Pick Local Dish', fr: '📍 Plat local', id: '📍 Hidangan lokal', ru: '📍 Местное блюдо', de: '📍 Lokales Gericht' },
  ...
  'card.try':               { en: 'Try',                fr: 'Essayez',          id: 'Coba',           ru: 'Попробуйте',     de: 'Probier' },
  'card.open':              { en: 'Open',               fr: 'Ouvert',           id: 'Buka',           ru: 'Открыто',        de: 'Offen' },
  'card.closed':            { en: 'Closed',             fr: 'Fermé',            id: 'Tutup',          ru: 'Закрыто',        de: 'Geschlossen' },
  'card.distAway':          { en: ' away',              fr: '',                 id: '',               ru: '',               de: '' },
  ...
  'sort.by':                { en: 'Sort',               fr: 'Trier',            id: 'Urut',           ru: 'Сорт.',          de: 'Sort.' },
  'sort.title':             { en: 'Title',              fr: 'Titre',            id: 'Judul',          ru: 'Назв.',          de: 'Titel' },
  'sort.country':           { en: 'Country',            fr: 'Pays',             id: 'Negara',         ru: 'Страна',         de: 'Land' },
  'sort.city':              { en: 'City',               fr: 'Ville',            id: 'Kota',           ru: 'Город',          de: 'Stadt' },
  'sort.cuisine':           { en: 'Cuisine',            fr: 'Cuisine',          id: 'Masakan',        ru: 'Кухня',          de: 'Küche' },
  'sort.date':              { en: 'Date',               fr: 'Date',             id: 'Tanggal',        ru: 'Дата',           de: 'Datum' },
  'loc.all':                { en: 'All locations',      fr: 'Tous les lieux',   id: 'Semua lokasi',   ru: 'Все места',      de: 'Alle Orte' },
  'loc.title':              { en: 'Saved locations',    fr: 'Lieux enregistrés', id: 'Lokasi tersimpan', ru: 'Сохранённые места', de: 'Gespeicherte Orte' },
  'loc.none':               { en: 'No saved-card locations yet.', fr: 'Aucun lieu enregistré.', id: 'Belum ada lokasi.', ru: 'Пока нет мест.', de: 'Noch keine Orte.' },
  'facet.rating':           { en: 'Rating',             fr: 'Note',             id: 'Rating',         ru: 'Рейтинг',        de: 'Bewertung' },
  'facet.price':            { en: 'Price',              fr: 'Prix',             id: 'Harga',          ru: 'Цена',           de: 'Preis' },
  'facet.open':             { en: '🟢 Open now',        fr: '🟢 Ouvert',        id: '🟢 Buka',        ru: '🟢 Открыто',     de: '🟢 Offen' },
  'facet.crowd':            { en: 'Crowd',              fr: 'Affluence',        id: 'Keramaian',      ru: 'Загруж.',        de: 'Andrang' },
  ...
  'chrome.edit':            { en: '✏️ Edit',             fr: '✎ Modifier',       id: '✎ Ubah',         ru: '✎ Изм.',         de: '✎ Bearb.' },
