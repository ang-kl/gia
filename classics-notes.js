...
// fact + native script against the source and trimmed each note to <=140 chars.
...
// opens an explanation card (operator: "each classic must have an explanation").
//
// v0.62.179 — SG now 162 of 163 classics (batch 1 + batch 2).
